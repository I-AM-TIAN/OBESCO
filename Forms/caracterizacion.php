...
<html lang="es">
  ...
  <body>
    <nav><h1 id="head"><a class="logo" href="../index.php">OBESCO</a></h1></nav>
    <div class="container">
        ...
        <form action="">
          <div class="company data">
            ...
            <div class="fields">
              ...
              <div class="buttons">
                <button class="nextBtn" onclick="transition()">
            ...
            <div class="associates-g">
              <div class="associates-m">
                ...
                <div class="fields-m">
                  ...
                  <div class="input-field">
                    <label
                      >Asociados que viven en situacion de pobreza segun pobreza
                  ...
                  <div class="input-field">
                    <label
                      >Asociados que integran el consejo de
                  ...
                  <div class="input-field">
                    <label
                      >Asociados que integran otros comites de la
                      organizacion</label
                    >
                  ...
                  <div class="input-field">
                    <label
                      >Hombres que representan la diversidad entre los
                      asociados</label
                    >
              ...
              <div class="associates-f">
                ...
                <div class="fields-f">
                  ...
                  <div class="input-field">
                    <label
                      >Asociadas que viven en situacion de pobreza segun pobreza
                      multidimensional</label
                    >
                  ...
                  <div class="input-field">
                    <label
                      >Asociadas que integran el consejo de
                      administracion</label
                    >
                  ...
                  <div class="input-field">
                    <label
                      >Asociadas que integran otros comites de la
                      organizacion</label
                    >
                  ...
                  <div class="input-field">
                    <label
                      >Mujeres que representan la diversidad entre los
                      asociados</label
                    >
                    <input
                      type="number"
          ...
          <div class="members">
            ...
            <div class="fields">
              ...
              <div class="input-field">
                ...
                <input type="number placeholder="Ingrese el total de empleados"
                id="emp-18" name="emp-18" required />
              </div>
              ...
              <div class="input-field">
                <label
                  >Empleados que tienen afiliacion a seguridad social-arl</label
                >
              ...
              <div class="input-field">
                <label
                  >Empleados que tienen afiliacion a seguridad
            ...
            <div class="members-g">
              ...
              <div class="members-f">
                ...
                <div class="fields-f">
                  ...
                  <div class="input-field">
                    <label
                      >Mujeres que representan la diversidad entre las
                      trabajadoras</label
                    >
                    <input
                      type="number"
