          ...
          <div class="seccion1">
            ...
            <div class="fields">
              <div class="input-field">
                <label
                  >La convocatoria a los asociados para participar de las
              ...
              <div class="input-field">
                <label
                  >Los acuerdos para la toma de decisiones son claros y se
                  aplican
                </label>
              ...
              <div class="input-field">
                <label
                  >Realiza algún tipo de evaluación de la experiencia asociativa
                  de manera periódica
                </label>
              ...
              <div class="input-field">
                <label
                  >Los comités y consejos definidos en los estatutos funcionan
              ...
              <div class="input-field">
                <label
                  >Se promueve relación más allá de la comercial con los
                  asociados
                </label>
              ...
              <div class="input-field">
                <label
                  >Se generan oportunidad para ocupar cargos directivos a
              ...
              <div class="input-field">
                <label
                  >Desarrollan planes de formación en asociatividad, trabajo en
              ...
              <div class="input-field">
                <label
                  >Participan de dinámicas de red, integración en su territorio
                </label>
              ...
              <div class="input-field">
                <label
                  >La organizacion participa en espacios ciudadanos convocados
              ...
              <div class="input-field">
                <label
                  >Se relacionan y mantiene proyectos comunes con organizaciones
              ...
              <div class="input-field">
                <label
                  >Participa de programas de capacitación o gestión en
              ...
              <div class="input-field">
                <label
                  >Participa de espacios locales de gestión del territorio como
      ...
      <div id="p2" class="page2">
        <form action="">
          <div class="seccion2">
            <p></p>
            <span class="title"
              >Generación de trabajo, ingresos, calidad de vida
            </span>
            <div class="fields">
              <div class="input-field">
                <label
                  >La actividad de la organización genera empleos directos
                </label>
              ...
              <div class="input-field">
                <label
                  >Implementa contratación laboral para los empleados cumpliendo
              ...
              <div class="input-field">
                <label
                  >Las actividades y estrategias de la organización le permite a
              ...
              <div class="input-field">
                <label
                  >La generación de ingresos le permite a los asociados
              ...
              <div class="input-field">
                <label
                  >Desarrollan políticas de inclusión de mujeres, jóvenes a las
              ...
              <div class="input-field">
                <label
                  >Evalua el impacto en la calidad de vida de los asociados
              ...
              <div class="input-field">
                <label
                  >La actividad económica de la organización permite la
              ...
              <div class="input-field">
                <label
                  >La actividad de generación de ingresos le permite a los
        ...
        <form action="">
          <div class="seccion3">
            ...
            <div class="fields">
              <div class="input-field">
                <label
                  >Utilizan herramientas de gestión administrativa, contable,
                  logísticos
                </label>
              ...
              <div class="input-field">
                <label
                  >Realiza división de funciones y tareas según un organigrama
              ...
              <div class="input-field">
                <label
                  >Realiza actividades de rendición de cuentas a sus asociados y
              ...
              <div class="input-field">
                <label
                  >La gestión administrativa se realiza mediante contratación
                  laboral formal
                </label>
              ...
              <div class="input-field">
                <label
                  >Evalúa de forma periódica la planeación y los resultados
                </label>
              ...
              <div class="input-field">
                <label
                  >Utiliza TIC para la gestión de producción y comercialización
                </label>
              ...
              <div class="input-field">
                <label
                  >La organización accede a a recursos financieros externos
              ...
              <div class="input-field">
                <label
                  >La organización desarrolla mecanismos internos de finanzas
              ...
              <div class="input-field">
                <label
                  >La organización genera excedentes financieros (evaluar los
                  últimos 3 años)
                </label>
              ...
              <div class="input-field">
                <label
                  >La organización eestá creando capacidad productiva (activos
              ...
              <div class="input-field">
                <label
                  >Desarrolla algun tipo de herramientas de comunicación
                </label>
              ...
              <div class="input-field">
                <label
                  >Mantienen información sobre necesidades y oferta de los
              ...
              <div class="input-field">
                <label
                  >Actualiza la informacion sobre las cadenas de proveedores y
                  clientes
                </label>
        ...
        <form action="">
          <div class="seccion4">
            ...
            <div class="fields">
              <div class="input-field">
                <label
                  >Aplica una metodología para establecer los precios de los
              ...
              <div class="input-field">
                <label
                  >Identifica a la competencia y aliados como una acción
              ...
              <div class="input-field">
                <label
                  >Tiene política de comercialización e incluye el comercio
              ...
              <div class="input-field">
                <label
                  >La logística para la comercialización es propia (transporte,
                  insumos, etc)
                </label>
              ...
              <div class="input-field">
                <label
                  >Tiene capacidad para diseñar estrategias de mercadeo propias
                </label>
              ...
              <div class="input-field">
                <label
                  >Conoce a los clientes y conoce sus intereses, gustos,
                  necesidades
                </label>
              ...
              <div class="input-field">
                <label
                  >Participa de procesos articulados de comercialización con
      ...
      <div id="p5" class="page5">
        <form action="">
          <div class="seccion5">
            <p></p>
            <span class="title"
              >Capacidades productivas (solo para las del sector primario y
              secundario)
            </span>
            <div class="fields">
              <div class="input-field">
                <label
                  >Realiza compra conjunta entre los asociados, de insumos o
                  bienes de consumo
                </label>
              ...
              <div class="input-field">
                <label
                  >Genera producción continua y estable en volumen (evaluar el
                  último año)
                </label>
              ...
              <div class="input-field">
                <label
                  >Agrega valor a la producción (transformación, innovación,
                  otra)
                </label>
              ...
              <div class="input-field">
                <label
                  >Analizalos orígenes de los productos, para la compra de
              ...
              <div class="input-field">
                <label
                  >Conoce la capacidad productiva de los asociados (áreas,
              ...
              <div class="input-field">
                <label
                  >Identifica los efectos negativos que genera la actividad
                  productiva
                </label>
              ...
              <div class="input-field">
                <label
                  >Produce bajo principios de sustentabilidad ambiental
                </label>
      ...
      <div id="p6" class="page6">
        <form action="">
          <div class="seccion6">
            <p></p>
            <span class="title"
              >Capacidades para el servicio: solo para sector terciario
            </span>
            <div class="fields">
              <div class="input-field">
                <label
                  >Realiza compra a proveedores del sector solidario
                </label>
                <select id="aso61" name="aso62" required>
                  <option disabled selected>Seleccione</option>
                  <option value="0">No lo hace o no tiene la capacidad</option>
                  <option value="1">Lo hace poco o tiene poca capacidad</option>
                  <option value="2">
              ...
              <div class="input-field">
                <label
                  >Genera una oferta de servidios continua y de calidad
                </label>
              ...
              <div class="input-field">
                <label
                  >Agrega valor a los servicios respecto de otras empresas
                  privadas
                </label>
              ...
              <div class="input-field">
                <label
                  >Se articula el servicio con circuitos locales de
                  comercialización
                </label>
              ...
              <div class="input-field">
                <label
                  >Analiza los orígenes de los productos, para la compra de
              ...
              <div class="input-field">
                <label
                  >Su tamaño empresarial le permite competir con el sector
                  privado
                </label>
              ...
              <div class="input-field">
                <label
                  >Identifica los efectos negativos que genera la actividad de
                  servicios
                </label>
              ...
              <div class="input-field">
                <label
                  >Tiene programas ambientales de reducción de huella de
